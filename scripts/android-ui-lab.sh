...
Commands:
  ...
  launch <login|library|reader|poster|share|tasks|states|settings|categories>
...
validate_scenario() {
  case "$1" in login|library|reader|poster|share|tasks|states|settings|categories) ;; *) echo "Unknown UI Lab scenario: $1" >&2; exit 2;; esac
}
